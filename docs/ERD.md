...
"studio_account_schedules" {
  String id PK
  String studio_account_id FK
  String studio_repository_release_node_id
  String hub_customer_id FK
  String arguments
  DateTime created_at
  DateTime updated_at
...
"studio_account_widget_tile_component_of_workflows" {
  String id PK
  String studio_repository_workflow_id
  String arguments
}
...
"studio_meta_chat_session_goods" }o--|| "studio_meta_chat_sessions" : session
```
...
"hub_external_swagger_document_translates" {
  String id PK
  String hub_external_swagger_document_id FK
  Boolean original
  String url
  String lang_code
}
