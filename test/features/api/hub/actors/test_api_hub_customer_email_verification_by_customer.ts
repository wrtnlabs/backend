...
export const test_api_hub_customer_email_verification_by_customer = async (
  pool: ConnectionPool,
): Promise<void> => {
  try {
    ...
    await TestValidator.httpError("Different Customer")(404)(() =>
      HubApi.functional.hub.customers.emails.verifications.verify(
        pool.customer,
        {
