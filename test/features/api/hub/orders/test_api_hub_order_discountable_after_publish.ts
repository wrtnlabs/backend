...
export const test_api_hub_order_discountable_after_publish = async (
  pool: ConnectionPool,
): Promise<void> => {
  ...
  await TestValidator.httpError("published")(410)(() =>
    HubApi.functional.hub.customers.orders.discountable(
      pool.customer,
      order.id,
      {
        good_ids: null,
