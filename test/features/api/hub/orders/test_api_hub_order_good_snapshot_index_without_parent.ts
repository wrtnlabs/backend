...
export const test_api_hub_order_good_snapshot_index_without_parent = async (
  pool: ConnectionPool,
): Promise<void> => {
  ...
  TestValidator.equals("snapshots.length")(snapshots.data.length)(1);
};
