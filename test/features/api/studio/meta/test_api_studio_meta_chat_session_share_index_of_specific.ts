...
export const test_api_studio_meta_chat_session_share_index_of_specific = async (
  pool: ConnectionPool,
): Promise<void> => {
  ...
  const entire: IStudioMetaChatSessionShare[] = await ArrayUtil.asyncRepeat(10)(
    () =>
      HubApi.functional.studio.customers.meta.chat.sessions.shares.create(
        pool.customer,
        {
          title: "Test Title",
  ...
  TestValidator.equals("page.data")(page.data)(entire);
};
